    ...
    def devolver_libro(self, usuario, titulo):
        ...
        for libro in usuario.libros_prestados:
            if libro.titulo == titulo:
                ...
                libro.ejemplares_disponibles += 1
                print(
                    f"El libro {titulo} ha sido devuelto por {usuario.nombre}"
                )
    ...
    def mostrar_inventario(self):
        ...
        for libro in self.libros:
            print(
                ...
                f"Disponibles: {libro.ejemplares_disponibles}"
            )


# Ejemplo de Uso
biblioteca = Biblioteca()  # Crear una instancia de Biblioteca
libro1 = Libro("El Gran Gatsby", "F. Scott Fitzgerald", 3)  # Crear un libros
libro2 = Libro("Cien Años de Soledad", "Gabriel García Márquez", 5)

biblioteca.agregar_libro(libro1)  # Agregar libro1 al inventario
biblioteca.agregar_libro(libro2)  # Agregar libro2 al inventario
...
biblioteca.prestar_libro(
    usuario1, "El Gran Gatsby"
)  # Prestar libro1 a usuario1
biblioteca.prestar_libro(
    usuario2, "Cien Años de Soledad"
)  # Prestar libro2 a usuario2

biblioteca.mostrar_inventario()  # Mostrar el inventario de la biblioteca

biblioteca.devolver_libro(
    usuario1, "El Gran Gatsby"
)  # Devolver libro1 prestado por usuario1

# Mostrar el inventario de la biblioteca después de devolver un libro
